    ...
    <div class="bg-white rounded shadow w-2/3 mt-6 overflow-hidden">
        <div class="flex flex-col p-4">
            <div class="flex items-center">
                ...
                <div class="ml-6">
                    ...
                    <div class="font-sm text-gray-600">{{ post.data.attributes.posted_at }}</div>
                </div>
            </div>
            <div class="mt-4">
        ...
        <div class="flex justify-between border-1 border-gray-400 m-4">
            <button class="flex justify-center items-center py-2 rounded-lg text-sm text-gray-600 w-full"
                ...
                <div class="ml-2">Like</div>
            </button>
            <button
                class="flex justify-center py-2 rounded-lg text-sm text-gray-600 w-full hover:bg-gray-200"
            ...
            <div class="flex mt-3 items-center" v-for="comment in post.data.attributes.comments.data">
                ...
                <div class="ml-4 flex-1">
                    <div class="bg-gray-200 rounded-lg p-2 text-sm">
                        <a :href="'/users/' + comment.data.attributes.commented_by.data.user_id" class="no-underline font-bold text-blue-700">
                    ...
                    <div class="text-xs pl-4">
                        <p class="inline">{{ comment.data.attributes.commented_at }}</p>
                    </div>
                </div>
            </div>
