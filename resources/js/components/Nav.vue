        ...
        <div class="w-1/3">
            <div class="flex">
                ...
                <div class="ml-2 relative">
                    ...
                    <input type="text" name="search" class="rounded-full w-56 pl-8 bg-gray-200 h-8 focus:outline-none focus:ring focus:ring-blue-400 text-sm " placeholder="Search Facebook">
                </div>
            </div>
        </div>
